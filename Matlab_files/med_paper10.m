...
if(numSalti==1)
    ...
    [index_opt, Jmin, Jstore, x_reset]=FindJCostminStore_resetFFBumpless(cnt, indexes, numSalti, numStati_a, numStati_c, numStati_p, numStati_r, numStati_w, numeroCampioni, timeMesh, Mc1, Mc2, Aav, CI_a, Jnow, indexes, Jstore, CI_a, Tv, Pv, numStati, C_constraint);
    plot(t,Jstore);
...
Plot1=figure(2);
%ax(1)=subplot(2,1,1);
plot(t1,x_w_plot,t1,x_cc_normal_plot,t1,x_rd_plot(1,:), t1, x_cc_system_plot(1,:), t1, x_cc_system_plot(2,:),t1,x_ed_plot(1,:),t1,x_a_plot);
grid on
h=legend('w','$C_{switch}$', '$\overline{r}$', '$C_1$', '$C_2$', 'ed', 'xa'); 
