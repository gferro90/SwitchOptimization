function [index_opt, Jmin]=FindJCostmin(cnt, indexes, numSalti, numStati,numeroCampioni, timeMesh, Mc, Aev, x0, Jnow, index_opt)
Jmin=Jnow;
if(cnt>numSalti)
    %calcola Jmin
    invalid=0;
   %for i=1:numSalti
    ...
    for i=1:numeroCampioni
        indexes(cnt)=i;
        cnt=cnt+1;
        [index_opt, Jmin]=FindJCostmin(cnt, indexes, numSalti, numStati, numeroCampioni, timeMesh, Mc, Aev, x0, Jmin, index_opt);
        cnt=cnt-1;
    end
end
end