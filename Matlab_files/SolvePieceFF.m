function[MO, BO]= SolvePieceFF(ev,  Pv, Tv, j, numSalti, x0, MOtemp, BOtemp, numStati, numStati_a, numStati_c, numStati_p, numStati_r, numStati_w, flag)
  MO=MOtemp;
  BO=BOtemp;
  ...
  if(j==0)
      ...
      BO(1:numStati_cw,1)=BO(1:numStati_cw,1)-Rpr*xnc;
        ...
        [MO, BO]=SolvePieceFF(ev,  Prec, Tv, j-1, numSalti, x0, MO, BO, numStati, numStati_a, numStati_c, numStati_p, numStati_r,numStati_w,0);
